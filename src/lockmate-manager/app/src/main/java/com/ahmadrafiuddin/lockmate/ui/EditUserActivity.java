...
public class EditUserActivity extends AppCompatActivity {
    private String update_key_url = "http://gmm-student.fc.utm.my/~arbna/lockmate/update_key.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = (EditText) findViewById(R.id.txtbox_name2);
        matricNum = (EditText) findViewById(R.id.txtbox_matric_num2);
        password = (EditText) findViewById(R.id.txtbox_password2);
        btn_generatePwd = (Button) findViewById(R.id.btn_generate_pwd2);
        btn_submitUser = (Button) findViewById(R.id.btn_submit_user);

        floatingNameLabel = (TextInputLayout) findViewById(R.id.name_text_input_layout2);
        floatingMatricNumTextboxLabel = (TextInputLayout) findViewById(R.id.matric_num_text_input_layout2);
        floatingPasswordLabel = (TextInputLayout) findViewById(R.id.password_text_input_layout2);

        Bundle keyInfoBundle = getIntent().getBundleExtra(BUNDLE_KEY_INFO);
        ...
        btn_submitUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!name.getText().toString().isEmpty() && !matricNum.getText().toString().isEmpty() && !password.getText().toString().isEmpty()) {
                    ...
                    keyToSubmit.setId(selectedKey.getId());
